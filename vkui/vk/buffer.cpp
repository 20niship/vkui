...
auto get_device(){return getContextPtr()->renderer.get_device_ptr();}
auto get_command_pool(){return getContextPtr()->renderer.get_command_pool();}
auto get_graphicque(){return getContextPtr()->renderer.get_graphics_queue();}
auto get_physical_dev(){return getContextPtr()->renderer.get_physical_device_ptr();}
