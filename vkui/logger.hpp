...
#define uiLOGI ::vkUI::log_intermediate::make_info ( __FILE__, __LINE__ , MYLOGGER_GET_FUNCTION )
#define uiLOGD ::vkUI::log_intermediate::make_debug( __FILE__, __LINE__ , MYLOGGER_GET_FUNCTION )
#define uiLOGW ::vkUI::log_intermediate::make_warn ( __FILE__, __LINE__ , MYLOGGER_GET_FUNCTION )
#define uiLOGE ::vkUI::log_intermediate::make_error( __FILE__, __LINE__ , MYLOGGER_GET_FUNCTION )
